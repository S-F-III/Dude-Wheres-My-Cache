...
/**
 * Activity class for displaying and managing account information.
 * Provides options to view account details, modify account settings,
...
public class AccountInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configure navigation button listeners
