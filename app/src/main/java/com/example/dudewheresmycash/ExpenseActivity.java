...
public class ExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Apply edge-to-edge layout design
     ...
     * Used to unhighlight unselected expenses in the remove expense list.
     *
    ...
    /**
     * Populates the modify expense list with all expenses belonging to the current user.
     * Allows the user to select an expense for modification.
     *
     * @param userAcc The ID of the current user.
     */
    private void populateModifyExpenseList (String userAcc){
        ...
        if (expenseBank != null) {
            ...
            // Handle the modification of the selected expense
    ...
    /**
     * Populates the modify expense overlay with the details of the selected expense for editing.
     * Allows users to update an expense's amount, category, description, date, and recurrence status.
     *
     * @param userAcc   The ID of the current user.
